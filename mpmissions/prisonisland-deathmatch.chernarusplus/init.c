...
#include "C:/Program Files (x86)/Steam/steamapps/common/DayZServer/mpmissions/prisonisland-deathmatch.chernarusplus/clothes.c";
#include "C:/Program Files (x86)/Steam/steamapps/common/DayZServer/mpmissions/prisonisland-deathmatch.chernarusplus/weapons.c";
...
class CustomMission: MissionServer
{
	...
	void CustomMission()
    {
        ...
        GetGame().GetCallQueue(CALL_CATEGORY_GAMEPLAY).CallLater(this.CheckPlayerPositions, 10000, true);
    ...
    private void StartRound()
    {
		...
		this.NotifyAllPlayers("The round has started. Good luck!");
    }
    ...
    private void EndRound()
    {
        ...
        this.NotifyAllPlayers("Starting new round in 30 seconds... Get ready!", 12);
        ...
        foreach (Man man : men)
        {
            ...
            if (playerBase != null)
            {
                ...
                this.PlaceInLobby(playerBase);
				queue.CallLater(this.KillAllPlayers, 29000, false);
            }
        }
		
		queue.CallLater(this.CleanUpDeadBodies, 30000, false);
		queue.CallLater(this.StartRound, 30000, false);
    }
    ...
    private void PlaceInLobby(EntityAI entity)
    {
